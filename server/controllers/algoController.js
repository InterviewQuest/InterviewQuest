...
const addAlgo = async (req, res) => {
    ...
    try {
        const result = await pool.query('INSERT INTO algorithms(algorithm, difficulty, description, url) VALUES ($1, $2, $3, $4) RETURNING *', [algorithm, difficulty, description, url]);
